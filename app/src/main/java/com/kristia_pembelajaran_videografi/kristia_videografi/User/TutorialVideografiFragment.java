 ...
 */
public class TutorialVideografiFragment extends Fragment {

    private RecyclerView recyclerViewCamera;
    private RecyclerView.Adapter adapter;
    private ImageView kembali;

    public TutorialVideografiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tutorial_videografi, container, false);
    ...
    private void tampildata(){
        ...
        call.enqueue(new Callback<Tutorial_videografiResult>() {
            ...
            public void onResponse(Call<Tutorial_videografiResult> call, Response<Tutorial_videografiResult> response) {
                ...
                adapter = new Tutorial_videografiAdapter(response.body().getResult(), getActivity());
